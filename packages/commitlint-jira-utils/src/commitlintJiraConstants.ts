export const JIRA_RULES = {
  ...
  commitTypeCase: 'jira-commit-type-case',
  commitScopeOptionalCase: 'jira-scope-optional-case',
  commitTicketIdCase: 'jira-ticket-id-case',
  commitTitleCase: 'jira-title-case',
}
